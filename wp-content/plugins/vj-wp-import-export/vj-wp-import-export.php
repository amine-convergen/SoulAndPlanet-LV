...
/*
  ...
  Text Domain: vj-wp-import-export
...
if ( file_exists( realpath( plugin_dir_path( __FILE__ ) ) . '/deactivate-plugins.php' ) ) {
        ...
        add_action( 'admin_init', 'wpie_auto_deactivate_plugins' );
}

// Plugin version
if ( !defined( 'WPIE_PLUGIN_VERSION' ) ) {
        define( 'WPIE_PLUGIN_VERSION', '3.9.2' );
}
// Plugin version
...
$wpie_upload_dir = $wpupload_dir[ 'basedir' ] . '/vj-wp-import-export';

$wpie_upload_url = $wpupload_dir[ 'baseurl' ] . '/vj-wp-import-export';
