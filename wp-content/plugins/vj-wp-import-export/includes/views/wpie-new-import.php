                ...
                <form class="wpie_import_frm" method="post" action="#">
                        ...
                        <div class="wpie_content_data">
                                ...
                                <div class="wpie_section_container wpie_import_step3 wpie_import_step">
                                        ...
                                        <div class="wpie_section_wrapper">
                                                <div class="wpie_content_data_header wpie_section_wrapper_selected">
                                                        <div class="wpie_content_title"><?php esc_html_e( 'Add Filter', 'vj-wp-import-export' ); ?></div>
                                                </div>
                                                <div class="wpie_section_content wpie_show">
                                        ...
                                        <div class="wpie_section_wrapper wpie_file_options_wrapper">
                                                <div class="wpie_content_data_header wpie_section_wrapper_selected">
                                                        <div class="wpie_content_title"><?php esc_html_e( 'File Options', 'vj-wp-import-export' ); ?></div>
                                                </div>
                                                <div class="wpie_section_content wpie_file_option_container wpie_show"> 
                                                        ...
                                                        <div class="wpie_file_option_data_wrapper wpie_csv_delimiter_wrapper">
                                                                <div class="wpie_file_option_data_title"><?php esc_html_e( 'CSV Delimiter', 'vj-wp-import-export' ); ?></div>
                                                        ...
                                                        <div class="wpie_file_option_data_wrapper">
                                                                <div class="wpie_file_option_data_title"><?php esc_html_e( 'File Row Title', 'vj-wp-import-export' ); ?></div>
                                                                <div class="wpie_file_option_data_container">
                                                                        ...
                                                                        <label for="wpie_file_first_row_is_title" class="wpie_checkbox_label"><?php esc_html_e( 'File First Row is Row Title.', 'vj-wp-import-export' ); ?></label>
                                                                        <a class="wpie_doc_hint_url" href="<?php echo esc_url( 'https://plugins.vjinfotech.com/wordpress-import-export/documentation/csv-file-header-title/' ); ?>" target="_blank"><?php esc_html_e( 'Click Here For Details', 'vj-wp-import-export' ); ?></a>
                                                                </div>
                                                        </div>
                                                        <div class="wpie_file_option_data_wrapper">
                                                                <div class="wpie_btn wpie_btn_primary wpie_file_option_btn">
                                                                        <i class="fas fa-check wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Apply Options', 'vj-wp-import-export' ); ?>
                                                                </div>
                                                        </div>                                                      
                                                </div>
                                        </div>
                                        <div class="wpie_section_wrapper">
                                                <div class="wpie_content_data_header wpie_section_wrapper_selected">
                                                        <div class="wpie_content_title"><?php esc_html_e( 'File Data Preview', 'vj-wp-import-export' ); ?></div>
                                                </div>
                                                <div class="wpie_section_content wpie_show">                                                       
                                ...
                                <div class="wpie_section_container wpie_import_step4 wpie_import_step">
                                        ...
                                        <div class="wpie_section_notice"><?php esc_html_e( 'Note : Filling some data is required. You can fill in the data through the load settings or manually', 'vj-wp-import-export' ); ?></div>
                                        <div class="wpie_section_wrapper">
                                                <div class="wpie_content_data_header wpie_section_wrapper_selected">
                                                        <div class="wpie_content_title"><?php esc_html_e( 'Load & Save Settings', 'vj-wp-import-export' ); ?></div>
                                                </div>
                                                <div class="wpie_section_content wpie_show">
                                                        <div class="wpie_import_manage_template_section">
                                                                <div class="wpie_field_mapping_container_wrapper">
                                                                        <div class="wpie_field_mapping_container_title wpie_active"><?php esc_html_e( 'Load Settings', 'vj-wp-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                                                        <div class="wpie_field_mapping_container_data wpie_show">
                                                                                <div class="wpie_field_mapping_container_outer">
                                                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'From Saved Settings', 'vj-wp-import-export' ); ?></div>
                                                                                        <div class="wpie_image_option_wrapper">
                                                                                                <select class="wpie_content_data_select wpie_template_list" name="">
                                                                                                        <option value=""><?php _e( 'Select Setting', 'vj-wp-import-export' ); ?></option>
                                                                                                </select>
                                                                                        </div>
                                                                                ...
                                                                                <div class="wpie_field_mapping_container_outer wpie_load_import_settings_wrapper">                                                                                        
                                                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'From Imports', 'vj-wp-import-export' ); ?></div>
                                                                                        <div class="wpie_image_option_wrapper">
                                                                ...
                                                                <div class="wpie_field_mapping_container_wrapper">
                                                                        <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Save Settings', 'vj-wp-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                                                        <div class="wpie_field_mapping_container_data">
                                                                                <div class="wpie_field_mapping_container_outer">                                                                                        
                                                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Setting Name', 'vj-wp-import-export' ); ?></div>
                                                    ...
                                                    if ( current_user_can( 'wpie_add_shortcode' ) ) {
                                                            ...
                                                            ?>
                                                                <div class="wpie_hint_wrapper">
                                                                        <div class="wpie_hint_text"><i class="far fa-question-circle wpie_hint_text_icon"></i><?php esc_html_e( 'Shortcode allowed in field. for more', 'vj-wp-import-export' ); ?> <a target="_blank" class="wpie_hint_link" href="http://plugins.vjinfotech.com/wordpress-import-export/documentation/add-shortcode/"><?php esc_html_e( 'click here', 'vj-wp-import-export' ); ?></a></div>
                                                                </div>                                     
                                                                <?php
                                                        } else {
                                                                ...
                                                                ?>
                                                                <div class="wpie_hint_wrapper">
                                                                        <div class="wpie_hint_text wpie_hint_text_warning"><i class="far fa-question-circle wpie_hint_text_icon"></i><?php esc_html_e( 'Please contact admin for allow shortcode in field. for more', 'vj-wp-import-export' ); ?> <a target="_blank" class="wpie_hint_link" href="http://plugins.vjinfotech.com/wordpress-import-export/documentation/add-shortcode/"><?php esc_html_e( 'click here', 'vj-wp-import-export' ); ?></a></div>
                                                                </div>  
                                                        <?php } ?>
                                ...
                                <div class="wpie_section_container wpie_import_step5 wpie_import_step">
                                        ...
                                        <div class="wpie_section_wrapper ">
                                                <div class="wpie_content_data_header wpie_section_wrapper_selected">
                                                        <div class="wpie_content_title"><?php esc_html_e( 'Handle Existing Items', 'vj-wp-import-export' ); ?></div>
                                                ...
                                                <div class="wpie_section_content wpie_show">
                                                        ...
                                                        <div class="wpie_field_mapping_container_wrapper">
                                                                <div class="wpie_field_mapping_container_title wpie_active"><?php esc_html_e( 'Search Existing Item', 'vj-wp-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                                                <div class="wpie_field_mapping_container_data wpie_show">
                                                                        <div class="wpie_field_mapping_container_outer">
                                                        ...
                                                        <div class="wpie_section_content_notice"><?php esc_html_e( 'Note : Please choose only field that you have filled in previous step and you want to update otherwise you can lose your some of data. Not apply on creating new items', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_field_mapping_container_wrapper wpie_update_item_data_container">
                                                                <div class="wpie_field_mapping_container_title wpie_active"><?php esc_html_e( 'Update Existing items Fields', 'vj-wp-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                                                <div class="wpie_field_mapping_container_data wpie_show">
                                                                        <div class="wpie_field_mapping_container_outer">
                                ...
                                <div class="wpie_section_container wpie_import_step6 wpie_import_step">
                                        ...
                                        <div class="wpie_section_wrapper ">
                                                ...
                                                <div class="wpie_section_content wpie_show">
                                                        ...
                                                        <div class="wpie_import_summary_text wpie_import_item_selection_text wpie_existing_item_skip"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( 'Existing data will be skipped with the data specified in this import.', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_import_summary_text wpie_import_item_selection_text wpie_existing_item_update"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( 'Existing data will be updated with the data specified in this import.', 'vj-wp-import-export' ); ?></div>                            
                                                        <div class="wpie_import_summary_text wpie_import_item_selection_text wpie_new_item_create"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "New Items will be created from records that don't match the above criteria.", 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_import_summary_text wpie_import_item_selection_text wpie_new_item_skip"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "New Items will be skipped from records that don't match the above criteria.", 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_import_summary_text wpie_import_hidh_speed_text wpie_hidden"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "High-Speed, Small File Processing enabled. Your import will fail if it takes longer than your server's max_execution_time.", 'vj-wp-import-export' ); ?></div>
                                                        ...
                                                        <div class="wpie_import_summary_text wpie_import_iteration_text wpie_import_iteration_chunks_text wpie_hidden"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "Your file will be split into 1000 records chunks before processing.", 'vj-wp-import-export' ); ?></div>
                                                </div>
                                        </div>
                                        <div class="wpie_import_action_btn_wrapper ">
                                                <div class="wpie_import_action_container wpie_pre_import_btn">
                                                ...
                                                <div class="wpie_section_content wpie_show">
                                                        ...
                                                        <table class="wpie_import_details_table">
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td class="wpie_import_details">
                                                                                <div class="wpie_import_process_content wpie_import_details_right_wrapper">                                           
                                                                                        <div class="wpie_import_process_count_label"><?php esc_html_e( 'Imported', 'vj-wp-import-export' ); ?></div>
...
<div class="modal fade wpie_import_bg_set" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                        <div class="modal-header">
                                <h5 class="modal-title" ><?php esc_html_e( 'Background Import', 'vj-wp-import-export' ); ?></h5>
                        </div>
                        <div class="modal-body">
                                <div class="wpie_process_action_msg"><?php esc_html_e( 'Background Process Successfully Set', 'vj-wp-import-export' ); ?></div>
                        </div>
                        <div class="modal-footer">                                       
                                <a class="wpie_btn wpie_btn_primary" href="<?php echo admin_url( "admin.php?page=wpie-new-import" ); ?>">
                                        <i class="fas fa-plus wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'New Import', 'vj-wp-import-export' ); ?>
                                </a>
                                <a class="wpie_btn wpie_btn_primary " href="<?php echo admin_url( "admin.php?page=wpie-manage-import" ); ?>">
                                        <i class="fas fa-cogs wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Manage Import', 'vj-wp-import-export' ); ?>
                                </a>
                        </div>
                </div>
        </div>
