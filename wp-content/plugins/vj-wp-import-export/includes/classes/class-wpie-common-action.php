...
class WPIE_Common_Actions {
        ...
        public function wpie_save_user_cap() {
                ...
                $return_value[ 'message' ] = __( 'Role Successfully Saved', 'vj-wp-import-export' );
        ...
        public function wpie_delete_tempaltes() {
                ...
                if ( !empty( $ids ) ) {
                        ...
                        if ( !empty( $ids ) ) {
                                ...
                                foreach ( $ids as $id ) {
                                        ...
                                        if ( in_array( $opration, [ "import", "schedule_import" ] ) ) {

                                                if ( $opration === "schedule_import" ) {
                                        ...
                                        } elseif ( in_array( $opration, [ "export", "schedule_export" ] ) ) {
                ...
                $data = [ 'status' => 'success', "message" => __( 'Templates Successfully Deleted', 'vj-wp-import-export' ) ];
        ...
        public function wpie_save_advance_option() {
                ...
                $return_value[ 'message' ] = __( 'Settings Successfully Saved', 'vj-wp-import-export' );
                        ...
                        if ( $movefile && isset( $movefile[ 'file' ] ) && !isset( $movefile[ 'error' ] ) ) {
                                ...
                                if ( !empty( $template_data ) ) {
                                        ...
                                        if ( !empty( $template_data ) ) {
                                                ...
                                                $return_value[ 'status' ] = 'success';
                                                $return_value[ 'message' ] = __( 'Templates Successfully Imported', 'vj-wp-import-export' );
                                        } else {
                                                $return_value[ 'status' ] = 'error';
                                                $return_value[ 'message' ] = __( 'Empty Data', 'vj-wp-import-export' );
                                        }
                                } else {
                                        $return_value[ 'status' ] = 'error';
                                        $return_value[ 'message' ] = __( 'Empty Data', 'vj-wp-import-export' );
                                ...
                                $return_value[ 'status' ] = 'error';
                                $return_value[ 'message' ] = isset( $movefile[ 'error' ] ) ? $movefile[ 'error' ] : __( 'Error When move uploaded file', 'vj-wp-import-export' );
                        }
                }
        ...
        public function update_process_status() {
                ...
                if ( $wpie_import_id > 0 ) {
                        ...
                        if ( $process_status == "bg" ) {
                                ...
                                $return_value[ 'message' ] = __( 'Process Paused Successfully', 'vj-wp-import-export' );
                        }
        ...
        public function wpie_save_bg_cron_processing() {
                ...
                $return_value = array( "status" => 'success', "message" => __( 'Settings Successfully Saved', 'vj-wp-import-export' ) );
