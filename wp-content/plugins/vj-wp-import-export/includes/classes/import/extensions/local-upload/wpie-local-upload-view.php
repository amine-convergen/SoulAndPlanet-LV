...
<div class="wpie_upload_outer_container">
        <div id="wpie_upload_container" class="wpie_upload_container" >
                <div id="wpie_upload_drag_drop" class="wpie_upload_drag_drop">
                        <div class="wpie_upload_file_label"><?php esc_html_e( 'Drop file here', 'vj-wp-import-export' ); ?></div>
                        <div class="wpie_upload_file_label_small"><?php esc_html_e( 'OR', 'vj-wp-import-export' ); ?></div>
                        <div class="wpie_upload_file_btn">
                                <input id="plupload_browse_button" type="button" value="<?php esc_attr_e( 'Select Files', 'vj-wp-import-export' ); ?>" class="wpie_btn wpie_btn_primary wpie_btn_radius wpie_plupload_browse_button" />
                        </div>
                </div>
        ...
        <div class="wpie_uploaded_file_list_wrapper">
                <div class="wpie_local_uploaded_filename_wrapper">
                        <div class="wpie_local_uploaded_filename_label"><?php esc_html_e( 'Uploading', 'vj-wp-import-export' ); ?></div>
        ...
        <div class="wpie_text_format_list_wrapper">
                <div class="wpie_text_format_list_header"><?php esc_html_e( 'Data Format', 'vj-wp-import-export' ); ?></div>
                <div class="wpie_text_format_list_container">
                        <div class="wpie_text_format_list_element" >
                                ...
                                <label class="wpie_text_format_list_data wpie_radio_label"  for="wpie_text_format_list_csv"><?php esc_html_e( 'CSV', 'vj-wp-import-export' ); ?></label>
                        </div>
                        <div class="wpie_text_format_list_element" >
                                ...
                                <label class="wpie_text_format_list_data wpie_radio_label"  for="wpie_text_format_list_json"><?php esc_html_e( 'JSON', 'vj-wp-import-export' ); ?></label>
                        </div>
                        <div class="wpie_text_format_list_element" >
                                ...
                                <label class="wpie_text_format_list_data wpie_radio_label"  for="wpie_text_format_list_xml"><?php esc_html_e( 'XML', 'vj-wp-import-export' ); ?></label>
                        </div>
                </div>
        </div>
</div>