                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        ...
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_opengraph-image_url" class="wpie_radio_label"><?php esc_html_e( 'Download images hosted elsewhere', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Image URL with http:// or https://", "vj-wp-import-export" ); ?>"></i></label>
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_opengraph-image_media_library" class="wpie_radio_label"><?php esc_html_e( 'Use images currently in Media Library', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_opengraph-image_directory" class="wpie_radio_label"><?php echo esc_html( __( 'Use images currently uploaded in', 'vj-wp-import-export' ) . " " . WPIE_UPLOAD_TEMP_DIR ); ?> </label>
                                                                        <div class="wpie_radio_container">
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        ...
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_twitter-image_url" class="wpie_radio_label"><?php esc_html_e( 'Download images hosted elsewhere', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Image URL with http:// or https://", "vj-wp-import-export" ); ?>"></i></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_twitter-image_media_library" class="wpie_radio_label"><?php esc_html_e( 'Use images currently in Media Library', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_twitter-image_directory" class="wpie_radio_label"><?php echo esc_html( __( 'Use images currently uploaded in', 'vj-wp-import-export' ) . " " . WPIE_UPLOAD_TEMP_DIR ); ?> </label>
                                                                        <div class="wpie_radio_container">
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        ...
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_noindex_index" class="wpie_radio_label"><?php esc_html_e( 'Index', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_noindex_noindex" class="wpie_radio_label"><?php echo esc_html_e( 'No Index', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_noindex_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        ...
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_is_cornerstone_no" class="wpie_radio_label"><?php esc_html_e( 'No', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_is_cornerstone_yes" class="wpie_radio_label"><?php echo esc_html_e( 'Yes', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_wpseo_is_cornerstone_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container wpie_as_specified_wrapper">
