        ...
        function wpie_import_get_yoast_seo_post_tab( $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title">
                            <?php esc_html_e( 'Yoast SEO', 'vj-wp-import-export' ); ?>
                        ...
                        <div class="wpie_field_mapping_container_data">
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Focus Keywords', 'vj-wp-import-export' ); ?></div>
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'SEO Title', 'vj-wp-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <input type="text" class="wpie_content_data_input wpie_item__yoast_wpseo_title" name="wpie_item__yoast_wpseo_title" value=""/>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Meta Description', 'vj-wp-import-export' ); ?></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                <input type="text" class="wpie_content_data_input wpie_item__yoast_wpseo_metadesc" name="wpie_item__yoast_wpseo_metadesc" value=""/>
                                        </div>
                                </div>                                                                
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Keyphrase Synonyms', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Multiple values separated by || Example value1||value2||value3", "vj-wp-import-export" ); ?>"></i></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Related keyphrase', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Multiple values separated by || Example value1||value2||value3", "vj-wp-import-export" ); ?>"></i></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <div class="wpie_inner_section">
                                        <div class="wpie_inner_section_label"><?php esc_html_e( 'Facebook Options', 'vj-wp-import-export' ); ?><i class="fas fa-chevron-down wpie_inner_section_icon" aria-hidden="true"></i></div>
                                        <div class="wpie_inner_section_container">
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Title', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If you don't want to use the post title for sharing the post on Facebook but instead want another title there, import it here.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Description', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If you don't want to use the meta description for sharing the post on Facebook but want another description there, write it here.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Image', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If you want to override the image used on Facebook for this post, import one here. The recommended image size for Facebook is 1200 x 628px.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_opengraph-image_url" class="wpie_radio_label"><?php esc_html_e( 'Download images hosted elsewhere', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Image URL with http:// or https://", "vj-wp-import-export" ); ?>"></i></label>
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_opengraph-image_media_library" class="wpie_radio_label"><?php esc_html_e( 'Use images currently in Media Library', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_opengraph-image_directory" class="wpie_radio_label"><?php echo esc_html( __( 'Use images currently uploaded in', 'vj-wp-import-export' ) . " " . WPIE_UPLOAD_TEMP_DIR ); ?> </label>
                                                                        <div class="wpie_radio_container">
                                ...
                                <div class="wpie_inner_section">
                                        <div class="wpie_inner_section_label"><?php esc_html_e( 'Twitter Options', 'vj-wp-import-export' ); ?><i class="fas fa-chevron-down wpie_inner_section_icon" aria-hidden="true"></i></div>
                                        <div class="wpie_inner_section_container">
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Title', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If you don't want to use the post title for sharing the post on Twitter but instead want another title there, import it here.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Description', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If you don't want to use the meta description for sharing the post on Twitter but want another description there, write it here.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Image', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If you want to override the image used on Twitter for this post, import one here. The recommended image size for Twitter is 1024 x 512px.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_twitter-image_url" class="wpie_radio_label"><?php esc_html_e( 'Download images hosted elsewhere', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Image URL with http:// or https://", "vj-wp-import-export" ); ?>"></i></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_twitter-image_media_library" class="wpie_radio_label"><?php esc_html_e( 'Use images currently in Media Library', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container">
                                                                ...
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_twitter-image_directory" class="wpie_radio_label"><?php echo esc_html( __( 'Use images currently uploaded in', 'vj-wp-import-export' ) . " " . WPIE_UPLOAD_TEMP_DIR ); ?> </label>
                                                                        <div class="wpie_radio_container">
                                ...
                                <div class="wpie_inner_section">
                                        <div class="wpie_inner_section_label"><?php esc_html_e( 'Advanced Options', 'vj-wp-import-export' ); ?><i class="fas fa-chevron-down wpie_inner_section_icon" aria-hidden="true"></i></div>
                                        <div class="wpie_inner_section_container">
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Meta Robots Index', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-noindex_index" class="wpie_radio_label"><?php esc_html_e( 'Index', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-noindex_noindex" class="wpie_radio_label"><?php echo esc_html_e( 'No Index', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-noindex_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                                                ...
                                                                                <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The value should be one of the following: ('noindex', 'index').", "vj-wp-import-export" ); ?>"></i>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Meta Robots Nofollow', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-nofollow_default" class="wpie_radio_label"><?php esc_html_e( 'Default', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-nofollow_nofollow" class="wpie_radio_label"><?php echo esc_html_e( 'Nofollow', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-nofollow_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                                                ...
                                                                                <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The value should be one of the following: ('', 'nofollow'). Leave blank for 'Default'", "vj-wp-import-export" ); ?>"></i>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Meta Robots Advanced', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-adv_default" class="wpie_radio_label"><?php esc_html_e( 'Default', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-adv_none" class="wpie_radio_label"><?php echo esc_html_e( 'None', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-adv_noimageindex" class="wpie_radio_label"><?php echo esc_html_e( 'No Image Index', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-adv_noarchive" class="wpie_radio_label"><?php echo esc_html_e( 'No Archive', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-adv_nosnippet" class="wpie_radio_label"><?php echo esc_html_e( 'No Snippet', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_meta-robots-adv_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                                                ...
                                                                                <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The value should be one of the following: ('', 'none','noimageindex','noarchive','nosnippet'). Leave blank for 'Default'", "vj-wp-import-export" ); ?>"></i>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'This article is cornerstone content', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_is_cornerstone_no" class="wpie_radio_label"><?php esc_html_e( 'No', 'vj-wp-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_is_cornerstone_yes" class="wpie_radio_label"><?php echo esc_html_e( 'Yes', 'vj-wp-import-export' ); ?></label>
                                                                </div>                                                              
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item__yoast_wpseo_is_cornerstone_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                        <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                                                ...
                                                                                <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The value should be one of the following: ('', '1'). Leave blank for 'Default'", "vj-wp-import-export" ); ?>"></i>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Breadcrumbs Title', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                <input type="text" class="wpie_content_data_input wpie_item__yoast_wpseo_bctitle" name="wpie_item__yoast_wpseo_bctitle" value=""/>
                                                        </div>
                                                </div>
                                                <div class="wpie_field_mapping_container_element">
                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Canonical URL', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "The canonical URL that this page should point to, leave empty to default to permalink. Cross domain canonical supported too.", "vj-wp-import-export" ); ?>"></i></div>
                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <?php if ( !(empty( $pageTypeOptions ) && empty( $articleTypeOptions )) ) { ?>
                                        <div class="wpie_inner_section">
                                                <div class="wpie_inner_section_label"><?php esc_html_e( 'Schema', 'vj-wp-import-export' ); ?><i class="fas fa-chevron-down wpie_inner_section_icon" aria-hidden="true"></i></div>
                                                <div class="wpie_inner_section_container">
                                                        <div class="wpie_field_mapping_container_element">
                                                                <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Page type', 'vj-wp-import-export' ); ?></div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                                ...
                                                                                <label for="wpie_item__yoast_wpseo_schema_page_type_default" class="wpie_radio_label"><?php esc_html_e( 'Default', 'vj-wp-import-export' ); ?></label>
                                                                        </div>
                                                                        <?php
                                                                        ...
                                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                                ...
                                                                                <label for="wpie_item__yoast_wpseo_schema_page_type_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                                <div class="wpie_radio_container wpie_as_specified_wrapper">
                                                        ...
                                                        <?php if ( $wpie_import_type === "post" ) { ?>
                                                                <div class="wpie_field_mapping_container_element">
                                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Article type', 'vj-wp-import-export' ); ?></div>
                                                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                                                ...
                                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                                        ...
                                                                                        <label for="wpie_item__yoast_wpseo_schema_article_type_default" class="wpie_radio_label"><?php esc_html_e( 'Default', 'vj-wp-import-export' ); ?></label>
                                                                                </div>
                                                                                <?php
                                                                                ...
                                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                                        ...
                                                                                        <label for="wpie_item__yoast_wpseo_schema_article_type_as_specified" class="wpie_radio_label"><?php esc_html_e( 'As specified', 'vj-wp-import-export' ); ?></label>
                                                                                        <div class="wpie_radio_container wpie_as_specified_wrapper">
