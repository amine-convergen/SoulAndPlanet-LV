...
<div class="wpie_upload_outer_container" >
        ...
        <input type="hidden" value="" class="wpie_upload_final_file_url" name="wpie_upload_final_file_url"/>
        <div  class="wpie_existing_file_upload_container">
                <div class="wpie_element_full_wrapper">
                        <div class="wpie_element_title"><?php esc_html_e( 'File URL', 'vj-wp-import-export' ); ?></div>
