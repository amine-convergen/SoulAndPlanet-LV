...
<div class="wpie_section_wrapper">
        <div class="wpie_content_data_header wpie_schedule_import">
                <div class="wpie_content_title"><?php esc_html_e( 'Automatic Scheduling with Background Import', 'vj-wp-import-export' ); ?></div>
                ...
                <div class="wpie_content_data_wrapper">
                        <table class="wpie_content_data_tbl table table-bordered">
                                        ...
                                        <td>
                                                <div class="wpie_options_data">
                                                        ...
                                                        <div class="wpie_options_data_content">
                                                                ...
                                                                <div class="wpie_import_default_hint"><?php esc_html_e( 'Give any name for schedule', 'vj-wp-import-export' ); ?></div>
                                                        </div>
                                                </div>
                                        </td>
                                        <td >
                                                <div class="wpie_options_data">
                                                        <div class="wpie_options_data_title"><?php esc_html_e( 'Import Interval', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_options_data_content">
                                                                <select class="wpie_content_data_select wpie_sceduled_import_interval" data-placeholder="' . esc_attr__('Select Interval', 'vj-wp-import-export') . '" name="wpie_import_interval">
                                                                        <?php
                                ...
                                <tr>
                                        <td>
                                                <div class="wpie_options_data">
                                                        <div class="wpie_options_data_title"><?php esc_html_e( 'Import Interval Start Time', 'vj-wp-import-export' ); ?></div>
                                                        <div class="wpie_options_data_content">
                                                                <select class="wpie_content_data_select wpie_sceduled_import_interval_start_time" data-placeholder="' . esc_attr__('Select Interval TIme', 'vj-wp-import-export') . '" name="wpie_interval_start_time">
                                                                ...
                                                                <div class="wpie_import_default_hint"><?php esc_html_e( 'Default : Current time, Value : 00:00 to 23:30', 'vj-wp-import-export' ); ?></div>
                                                        </div>
                                                </div>
                                        </td>
                                        <td></td>
                                        ...
                                        <td colspan="2">
                                                <div class="wpie_options_data">
                                                        <div class="wpie_options_data_content">
                                                                ...
                                                                <div class="wpie_checkbox_container wpie_options_data_send_mail">
                                                                        <div class="wpie_schedule_mail_wrapper">
                                                                                <div class="wpie_options_data">
                                                                                        ...
                                                                                        <div class="wpie_options_data_content">
                                                                                                ...
                                                                                                <div class="wpie_import_default_hint"><?php esc_html_e( 'Ex. example@gmail.com, demo@yahoo.com', 'vj-wp-import-export' ); ?></div>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                        <div class="wpie_schedule_mail_wrapper">
                                                                        ...
                                                                        <div class="wpie_schedule_mail_wrapper">
                                                                                <div class="wpie_options_data">
                                                                                        ...
                                                                                        <div class="wpie_options_data_content">
                                                                                                <textarea class="wpie_content_data_textarea wpie_sceduled_import_msg" name="wpie_scheduled_email_msg"></textarea>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                </div>
                        ...
                        <div class="wpie_save_scheduled_btn_wrapper"> 
                                <div class="wpie_btn wpie_btn_primary wpie_save_scheduled_btn">
                                        <i class="fas fa-check wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Save Scheduled', 'vj-wp-import-export' ); ?>
                                </div>
                        </div>
                </div>
        </div>
        <div class="modal fade wpie_save_schedule_status_notify" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                                <div class="modal-header">
                                        <h5 class="modal-title wpie_export_proccess_title" ><?php esc_html_e( 'New Scheduled Created', 'vj-wp-import-export' ); ?></h5>
                                </div>
                                <div class="modal-body">
                                        <div class="wpie_process_action_msg"><?php esc_html_e( 'New Scheduled Created Successfully.', 'vj-wp-import-export' ); ?></div>
                                </div>
