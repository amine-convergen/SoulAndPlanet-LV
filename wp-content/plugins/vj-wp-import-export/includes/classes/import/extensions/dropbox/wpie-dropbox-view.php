        ...
        <div  class="wpie_file_upload_container">
                ...
                <div class="wpie_download_btn_wrapper">
                    <?php if ( $is_valid ) { ?>
                        ...
                        <?php } ?>
                        <a class="wpie_btn wpie_btn_primary wpie_dropbox_config_btn" href="<?php echo admin_url(); ?>admin.php?page=wpie-extensions&wpie_ext=wpie_import_dropbox_file_upload">
