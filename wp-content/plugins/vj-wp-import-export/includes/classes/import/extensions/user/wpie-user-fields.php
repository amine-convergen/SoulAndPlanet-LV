...
if ( !function_exists( "wpie_import_user_mapping_fields" ) ) {
        ...
        function wpie_import_user_mapping_fields( $sections = [], $wpie_import_type = "" ) {
                ...
                $role = "";
                $role_hint = __( "A string with role slug used to set the user's role. Default role is subscriber.", 'vj-wp-import-export' );
                if ( $wpie_import_type == "shop_customer" ) {
                        $role = "customer";
                        $role_hint = __( "A string with role slug used to set the user's role. Default role is customer.", 'vj-wp-import-export' );
                }
                ob_start();
                ...
                <div class="wpie_field_mapping_container_wrapper wpie_<?php echo esc_attr( $wpie_import_type ); ?>_field_mapping_container">
                        ...
                        <div class="wpie_field_mapping_container_data" style="display: block;">
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Role', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php echo esc_attr( $role_hint ); ?>"></i></div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        ...
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_required_field_notice"><?php esc_html_e( 'Note : Login / Username is required field for new items. Optional for update items', 'vj-wp-import-export' ); ?></div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                                ...
                                <div class="wpie_field_mapping_container_element">
                                        ...
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <div class="wpie_required_field_notice"><?php esc_html_e( 'Note : Email is required field for new items. Optional for update items', 'vj-wp-import-export' ); ?></div>
                                        </div>
                                </div>
                                <div class="wpie_field_mapping_container_element">
                        ...
                        <div class="wpie_field_mapping_container_data">
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label class="wpie_checkbox_label" for="wpie_item_send_email_notifications"><?php esc_html_e( "Send Email Notifications For Imported Users", 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "If disable, WP Import Export will prevent WordPress from sending notification emails to imported users while the import is processing.", "vj-wp-import-export" ); ?>"></i></label>
                                        </div>
                                </div>
                                ...
                                <div class="wpie_radio_container">
                                        ...
                                        <?php if ( $wpie_import_type == "shop_customer" ) { ?>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_billing" class="wpie_checkbox_label"><?php esc_html_e( 'Billing Details', 'vj-wp-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_shipping" class="wpie_checkbox_label"><?php esc_html_e( 'Shipping Details', 'vj-wp-import-export' ); ?></label>
                                                </div>
                                        <?php } ?>
                                        <div class="wpie_field_mapping_other_option_wrapper">
