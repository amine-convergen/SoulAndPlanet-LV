...
class WPIE_Images extends \wpie\import\base\WPIE_Import_Base {
        ...
        private function wpie_get_image_from_local( $filename = "" ) {
                ...
                if ( !file_exists( $file ) ) {
                        $this->import_log[] = '<strong>' . __( 'Warning', 'vj-wp-import-export' ) . '</strong> : ' . $filename . " " . __( 'Image Not Exist', 'vj-wp-import-export' );
                        return false;
                }
                if ( !$this->is_valid_image( $file ) ) {
                        $this->import_log[] = '<strong>' . __( 'Warning', 'vj-wp-import-export' ) . '</strong> : ' . $filename . " " . __( 'File is not valid Image', 'vj-wp-import-export' );
                        return false;
                }
                ...
                $this->import_log[] = '<strong>' . __( 'Warning', 'vj-wp-import-export' ) . '</strong> : ' . __( 'Image Upload failed', 'vj-wp-import-export' );
        ...
        private function wpie_get_image_from_url( $file_url = "" ) {
                ...
                if ( \is_wp_error( $fileName ) ) {
                        $this->import_log[] = '<strong>' . __( 'Warning', 'vj-wp-import-export' ) . '</strong> : ' . $fileName->get_error_message();
                        return false;
                }
                ...
                if ( \is_wp_error( $file ) ) {
                        $this->import_log[] = '<strong>' . __( 'Warning', 'vj-wp-import-export' ) . '</strong> : ' . $file->get_error_message();
                        return false;
                }
                ...
                if ( \is_wp_error( $id ) ) {
                        ...
                        $this->import_log[] = '<strong>' . __( 'Warning', 'vj-wp-import-export' ) . '</strong> : ' . $id->get_error_message();
                        return false;
                }
