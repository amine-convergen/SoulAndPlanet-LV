...
if ( !function_exists( "wpie_import_comment_mapping_fields" ) ) {
        ...
        function wpie_import_comment_mapping_fields( $sections = array(), $wpie_import_type = "" ) {
                ...
                if ( $wpie_import_type === "product_reviews" ) {
                        ...
                        $import_title = __( 'Product Reviews', 'vj-wp-import-export' );

                        $parent_type = __( 'Product', 'vj-wp-import-export' );
                } else {

                        $parent_type = __( 'Post', 'vj-wp-import-export' );
                        $import_title = __( 'Comment', 'vj-wp-import-export' );
                ...
                <div class="wpie_field_mapping_container_wrapper wpie_comment_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title wpie_active" ><?php echo esc_html( __( 'Search Parent', 'vj-wp-import-export' ) . " " . $parent_type ); ?> <div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                        <div class="wpie_field_mapping_container_data  wpie_field_mapping_other_option_outer_wrapper wpie_show" >
                            <?php if ( $wpie_import_type === "product_reviews" ) { ?>
                                ...
                                <?php } ?>
                                <div class="wpie_field_mapping_container_element">
                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Parent Post', 'vj-wp-import-export' ); ?><i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e( "Post can be matched by Slug, ID, or Title", "vj-wp-import-export" ); ?>"></i></div>
                ...
                ?>
                <div class="wpie_field_mapping_container_wrapper wpie_comment_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title" ><?php echo esc_html( $import_title . " " . __( 'Data', 'vj-wp-import-export' ) ); ?> <div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                ...
                <div class="wpie_field_mapping_container_wrapper">
                        <div class="wpie_field_mapping_container_title"><?php echo esc_html( $import_title . " " . __( 'Meta', 'vj-wp-import-export' ) ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
        ...
        function wpie_import_comment_search_existing_item( $sections = "", $wpie_import_type = "" ) {
                ...
                <div class="wpie_field_mapping_container_element">
                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <label for="wpie_existing_item_search_logic_cf" class="wpie_radio_label"><?php esc_html_e( 'Comment Meta', 'vj-wp-import-export' ); ?></label>
