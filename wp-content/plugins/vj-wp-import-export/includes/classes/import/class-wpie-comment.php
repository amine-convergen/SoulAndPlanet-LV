...
class WPIE_Comment extends \wpie\import\engine\WPIE_Import_Engine {
        ...
        public function process_import_data() {
                ...
                if ( $this->post_id == 0 ) {
                        ...
                        $this->set_log( "<strong>" . __( 'ERROR', 'vj-wp-import-export' ) . '</strong> : ' . __( 'Post not found', 'vj-wp-import-export' ) );
                ...
                if ( $this->is_new_item ) {
                        ...
                        if ( $this->item_id === false ) {
                                ...
                                $this->set_log( "<strong>" . __( 'ERROR', 'vj-wp-import-export' ) . '</strong> : ' . __( 'Fail to insert comment', 'vj-wp-import-export' ) );
                        ...
                        if ( is_wp_error( $is_success ) ) {
                                ...
                                $this->set_log( "<strong>" . __( 'ERROR', 'vj-wp-import-export' ) . '</strong> : ' . $is_success->get_error_message() );
