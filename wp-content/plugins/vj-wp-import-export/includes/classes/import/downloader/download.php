...
class Download {
        ...
        private function curl_download() {
                ...
                if ( $http_code !== 200 ) {
                        return new \WP_Error( 'download_error', __( "File Download Error : Invalid Status Code", 'vj-wp-import-export' ) );
                }
                if ( empty( $rawdata ) ) {
                        return new \WP_Error( 'download_error', __( "File Download Error : File is empty", 'vj-wp-import-export' ) );
                }
