...
class WPIE_General {
        ...
        public static function plugin_action_links( $links = array() ) {
                ...
                $plugin_links = [
                        '<a href="' . admin_url( "admin.php?page=wpie-new-import" ) . '">' . esc_html__( 'Import', 'vj-wp-import-export' ) . '</a>',
                        '<a href="' . admin_url( "admin.php?page=wpie-new-export" ) . '">' . esc_html__( 'Export', 'vj-wp-import-export' ) . '</a>',
                ];
        ...
        public static function wpie_set_admin_css() {
                ...
                if ( !empty( $page ) && in_array( $page, self::$wpie_page ) ) {
                        ...
                        if ( $page == 'wpie-new-export' ) {
                                ...
                                wp_enqueue_style( 'datatables.bootstrap4-css', WPIE_CSS_URL . '/dataTables.bootstrap4.min.css' );
        ...
        public static function wpie_set_admin_js() {
                ...
                if ( !empty( $page ) && in_array( $page, self::$wpie_page ) ) {
                        ...
                        if ( $page == 'wpie-new-export' ) {
                                ...
                                wp_enqueue_script( 'dataTables.bootstrap4-js', WPIE_JS_URL . '/dataTables.bootstrap4.min.js', array( 'jquery', 'bootstrap-js' ), WPIE_PLUGIN_VERSION, true );
