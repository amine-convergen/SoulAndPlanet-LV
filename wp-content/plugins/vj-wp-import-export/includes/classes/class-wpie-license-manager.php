...
class WPIE_License_Manager {
        ...
        function modify_plugin_update_message( $plugin_data, $response ) {
                ...
                echo '<br />' . sprintf( __( 'To enable updates, please enter your Purchase Code on the <a href="%s">Updates</a> page.', 'vj-wp-import-export' ), admin_url( 'admin.php?page=wpie-settings' ) );
        }
