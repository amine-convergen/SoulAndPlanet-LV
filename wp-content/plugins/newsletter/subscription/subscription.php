...
class NewsletterSubscription extends NewsletterModule {
    ...
    function get_subscription_form_custom($attrs = [], $content = '') {
        ...
        $buffer = '<form class="mc4wp-form" method="post" action="' . $action . '" class="' . $class . '" style="' . $style . '">' . "\n";
    ...
    function shortcode_newsletter_field($attrs, $content = '') {
        ...
        if ($name == 'email') {
            $buffer .= '<div class="tnp-field tnp-field-email mc4wp-form-fields">';

            $buffer .= '<i class="klbth-icon-mail"></i>';

            $buffer .= '<input class="tnp-email subscribe-input" placeholder="Votre adresse mail" type="email" name="ne" id="' . esc_attr($attrs['id']) . '" value=""';
    ...
    function get_subscription_form($referrer = '', $action = null, $attrs = []) {
        ...
        $buffer .= '<form class="mc4wp-form" method="post" action="' . esc_attr($action) . '">' . "\n\n";
        ...
        $buffer .= '<!--<div class="tnp-field tnp-field-button test">-->';
        ...
        if (strpos($options_profile['subscribe'], 'http') === 0) {
            ...
            $buffer .= '<input class="tnp-submit" style="width: auto;padding: 0 20px;" type="submit" value="' . esc_attr($options_profile['subscribe']) . '" ' . $button_style . '>' . "\n";
        }
