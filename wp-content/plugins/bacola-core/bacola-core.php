...
final class Bacola_Elementor_Addons
{
    ...
    */
    public function init_widgets()
    {
		...
		require_once( __DIR__ . '/elementor/widgets/bacola-products-categories-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Bacola_Product_Categories_Box() );
