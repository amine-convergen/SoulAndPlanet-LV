...
class Bacola_Home_Slider_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
        ...
        $repeater->add_control( 'slider_drow',
            [
                'label' => esc_html__( 'Drow Attention', 'chakta' ),
                'type' => Controls_Manager::TEXT,
                'description' => 'This input is for Short code',
                'label_block' => true,
                'default' => '',
                'pleaceholder' => esc_html__( 'Enter item short code here.', 'chakta' )
            ]
        );
        ...
        $repeater->add_control( 'slider_subtitle_2',
            [
                'label' => esc_html__( 'Item Subtitle 2', 'chakta' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => 'Only this week. Don’t miss...',
                'pleaceholder' => esc_html__( 'Enter item subtitle 2 here.', 'chakta' )
            ]
        );
        ...
        $repeater->add_control( 'slider_price_text_2',
        [
            'label' => esc_html__( 'Item Price Text 2', 'chakta' ),
            'type' => Controls_Manager::TEXT,
            'label_block' => true,
            'default' => 'from',
            'pleaceholder' => esc_html__( 'Add the price text.', 'chakta' )
	...
	protected function render() {
		...
		if ( $settings['slider_items'] ) {
			...
			echo '<div class="site-slider" data-slideshow="1" data-slidespeed="1200" data-autoplay="'.esc_attr($settings['auto_play']).'" data-autospeed="'.esc_attr($settings['auto_speed']).'" data-dots="'.esc_attr($settings['dots']).'" data-arrows="'.esc_attr($settings['arrows']).'">';
			...
			foreach ( $settings['slider_items'] as $item ) {
				...
				echo '<div class="entry-title">'.esc_html($item['slider_title']).'<span class="span-highlight">' . esc_html($item['slider_subtitle_2']).'</span></div>';
				echo '<div class="content-text">'.esc_html($item['slider_subtitle']).'</div>';
				echo '</div>';
				echo '<div class="content-footer">';
				echo '<p class="price-text">'.esc_html($item['slider_price_text']).' </p>';
                echo '<p class="price-text">'.esc_html($item['slider_price_text_2']).' </p>';
                ...
                if($item['slider_drow']){
                echo do_shortcode($item['slider_drow']);
                }
                else {
