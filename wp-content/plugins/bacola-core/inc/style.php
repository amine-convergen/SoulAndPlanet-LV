...
.sticky-header .header-main {
	...
	animation: .4s linear 0s slide;
	-webkit-animation: .4s linear 0s slide;
	-moz-animation: .4s linear 0s slide;
	-o-animation: .4s linear 0s slide;
	-ms-animation: .4s linear 0s slide;
}
<?php } ?>
