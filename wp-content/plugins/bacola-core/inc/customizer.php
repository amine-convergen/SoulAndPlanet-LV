...
function bacola_customizer_add_field ( $args ) {
	...
	/*====== Header ==================================================================================*/
		...
		$sections = array (
			...
			'header_icons' => array(
				esc_attr__( 'Header Icons ', 'bacola-core' ),
				esc_attr__( 'You can customize the icons which is on header..', 'bacola-core' )
			),
		...
		bacola_customizer_add_field (
			array(
				...
				'label' => esc_attr__( 'Logo Size', 'bacola-core' ),
		...
		bacola_customizer_add_field (
			array(
				'type' => 'image',
				'settings' => 'bacola_icon_admin',
				'label' => esc_attr__( 'Customer icon', 'bacola-core' ),
				'description' => esc_attr__( 'You can upload a Svg or png image.', 'bacola-core' ),
				'section' => 'bacola_header_icons_section',
				'choices' => array(
					'save_as' => 'id',
				),
			)
		...
		bacola_customizer_add_field (
			array(
				'type' => 'image',
				'settings' => 'bacola_icon_cart',
				'label' => esc_attr__( 'Cart icon', 'bacola-core' ),
				'description' => esc_attr__( 'You can upload a Svg or png image.', 'bacola-core' ),
				'section' => 'bacola_header_icons_section',
				'choices' => array(
					'save_as' => 'id',
				...
				'fields' => array(
					'mobile_menu_type' => array(
						...
						'choices' => array(
							...
							'search' => esc_attr__( 'Search', 'medibazar-core' ),
	...
	/*====== Footer ======*/
		...
		bacola_customizer_add_field (
			array(
				'type' => 'text',
				'settings' => 'bacola_footer_subscribe_highlight',
				'label' => esc_attr__( 'Subtitle 2', 'bacola-core' ),
				'description' => esc_attr__( 'You can set highlight for subscribe section.', 'bacola-core' ),
				'section' => 'bacola_footer_subscribe_section',
				'default' => '',
			)
		);
		...
		bacola_customizer_add_field (
			array(
				...
				'fields' => array(
					...
					'featured_svg' => array(
						'type' => 'image',
						'label' => esc_attr__( 'Image or SVG Name', 'bacola-core' ),
						'description' => esc_attr__( 'upload the image on the media on type the name.', 'bacola-core' ),
					),
					'featured_width' => array(
						'type' => 'text',
						'label' => esc_attr__( 'Width Icon', 'bacola-core' ),
						'description' => esc_attr__( 'set a width icon.', 'bacola-core' ),
					),
					'featured_height' => array(
						'type' => 'text',
						'label' => esc_attr__( 'Height Icon', 'bacola-core' ),
						'description' => esc_attr__( 'set a Height icon.', 'bacola-core' ),
					),
				),
			)
		);
		...
		bacola_customizer_add_field (
			array(
				'type' => 'image',
				'settings' => 'bacola_footer_bio_image',
				'label' => esc_attr__( 'Image', 'bacola-core' ),
				'description' => esc_attr__( 'You can upload an image Bio on the bottom of the footer.', 'bacola-core' ),
				'section' => 'bacola_footer_general_section',
				'choices' => array(
					'save_as' => 'id',
				),
		...
		bacola_customizer_add_field (
			array(
				'type' => 'image',
				'settings' => 'bacola_footer_bio_image_2',
				'label' => esc_attr__( 'Image', 'bacola-core' ),
				'description' => esc_attr__( 'You can upload an image Bio 2 on the bottom of the footer.', 'bacola-core' ),
				'section' => 'bacola_footer_general_section',
				'choices' => array(
					'save_as' => 'id',
				),
