...
<div id="password-lost-form-wrap">
	...
	<?php if ( $email_confirmed ) : ?>
		<?php $confirmed_text = esc_html__( 'Un e-mail a été envoyé. Veuillez vérifier votre boîte de réception' , 'frontend-reset-password' ); ?>
	...
	<form id="lostpasswordform" method="post" class="account-page-form">
		<fieldset>
			...
			<p class="no-margin">
				<label for="email"><?php _e( 'Adresse email', 'frontend-reset-password' ); ?></label>
