	...
	<form id="resetpasswordform" method="post" class="account-page-form som-pass-strength-form">
		<fieldset>
			...
			<p>
				...
				<label for="som_new_user_pass"><?php _e( 'Nouveau mot de passe', 'frontend-reset-password' ); ?></label>
			...
			<p>
				...
				<label for="som_new_user_pass_again"><?php _e( 'Entrez à nouveau le mot de passe', 'frontend-reset-password' ); ?></label>
