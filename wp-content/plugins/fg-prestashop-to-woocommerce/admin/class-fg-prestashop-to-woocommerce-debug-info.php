...
if ( !class_exists('FG_PrestaShop_to_WooCommerce_DebugInfo', false) ) {
	class FG_PrestaShop_to_WooCommerce_DebugInfo {
		
		private $option_names_filter = 'fgp2wc_get_option_names';
