...
<h2>Import in command line by WP CLI <span class="fgp2wc_premium_feature">(Premium feature)</span></h2>
...
<p>Here are the WP CLI commands that you can use:
	<ul>
		<li><strong>wp import-prestashop empty</strong> : Empty the imported data</li>
		<li><strong>wp import-prestashop empty all</strong> : Empty all the WordPress data</li>
		<li><strong>wp import-prestashop test_database</strong> : Test the database connection</li>
		<li><strong>wp import-prestashop import</strong> : Import the data</li>
		<li><strong>wp import-prestashop update</strong> : Update the data</li>
	</ul>
</p>

<h2>Automatic import by cron <span class="fgp2wc_premium_feature">(Premium feature)</span></h2>
<p>If you want to update automatically the existing products and orders, and import the new data that may have changed in the PrestaShop database, you can do it with a cron command.
	<ul>
