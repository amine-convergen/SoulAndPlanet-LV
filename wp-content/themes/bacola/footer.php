		...
		<footer class="site-footer">
						...
						<div class="row">
							<div class="col-12 col-lg-5">
								<div class="subscribe-content">
									...
									<div class="entry-title"><?php echo bacola_sanitize_data(get_theme_mod('bacola_footer_subscribe_subtitle')); ?>
								    <span class="subscribe-highlight"><?php echo bacola_sanitize_data(get_theme_mod('bacola_footer_subscribe_highlight')); ?></span></div>
									...
									<div class="form-wrapper">
									    ...
									    <?php dynamic_sidebar( 'newsletter-col' ); ?>
							...
							<?php foreach($featured_box as $featured){ ?>
								<div class="col col-12 col-md-6 col-lg-3">
									<div class="iconbox">
											...
											<?php $attachment_id = esc_html($featured['featured_svg']);
											if ($attachment_id != '') { ?>
											<div class="iconbox-icon" style=" max-width: inherit;flex: inherit;-ms-flex: inherit;" >
											<img src="<?php echo esc_url( wp_get_attachment_url($attachment_id,'thumbnail')); ?>" width="<?php  echo esc_html($featured['featured_width']); ?>" height="<?php echo esc_html($featured['featured_height']); ?>" class="tags-icon-col"/>
											</div>
											<?php ; } else  { ?>
											<div class="iconbox-icon" >
												<i class="<?php echo esc_attr($featured['featured_icon']); ?>"></i>
											</div>
											<?php ; } ?>
								...
								<div class="site-social">
									<ul>
										<?php foreach($footersocial as $f){ ?>
											<li><a href="<?php echo esc_url($f['social_url']); ?>" target="_blank">
											<img src="<?php echo get_attachment_url_by_title($f['social_icon']);  ?>" width="50px" />
											</a></li>
										<?php } ?>
									</ul>
								</div>
			...
			<div class="footer-bottom border-enable">
				...
				<div class="container">
							...
							<?php $footersocial = get_theme_mod('bacola_footer_social_list'); ?>
								<?php if(!empty($footersocial)){ ?>
									<div class="site-social">
										<ul>
											<?php foreach($footersocial as $f){ ?>
												<li style="margin-right: 20px;"><a href="<?php echo esc_url($f['social_url']); ?>" target="_blank">
												<img src="<?php echo get_attachment_url_by_title($f['social_icon']);  ?>" width="50px" />
												</a></li>
											<?php } ?>
										</ul>
						...
						<div class="site-brand footer-brand">
							<a href="<?php echo esc_url( home_url( "/" ) ); ?>" title="<?php bloginfo("name"); ?>">
								<?php if (get_theme_mod( 'bacola_logo' )) { ?>
									<?php $size = get_theme_mod( 'bacola_logo_size', array( 'width' => '140', 'height' => '44') ); ?>
						...
						<?php if(get_theme_mod('bacola_footer_bio_image')){ ?>
							<div class="site-payments site-bio">

								<img src="<?php echo esc_url( wp_get_attachment_url(get_theme_mod('bacola_footer_bio_image'))); ?>" alt="<?php esc_attr_e('bio-logo','bacola'); ?>" width="60">
								<?php if(get_theme_mod('bacola_footer_bio_image_2')){ ?>
									<img src="<?php echo esc_url( wp_get_attachment_url(get_theme_mod('bacola_footer_bio_image_2'))); ?>" alt="<?php esc_attr_e('bio logo 2','bacola'); ?>" width="50"style="padding-left: 10px;">
						...
						<?php if(get_theme_mod('bacola_footer_payment_image')){ ?>
							<div class="site-payments">
								<?php if(get_theme_mod('bacola_footer_payment_image_url') !=''){ ?>
									<a href="<?php echo esc_url(get_theme_mod('bacola_footer_payment_image_url')); ?>">
								<?php } ?>
								<img src="<?php echo esc_url( wp_get_attachment_url(get_theme_mod('bacola_footer_payment_image'))); ?>" alt="<?php esc_attr_e('payment','bacola'); ?>">
								<?php if(get_theme_mod('bacola_footer_payment_image_url') !='' ){ ?>
									</a>
								<?php } ?>
							</div>
