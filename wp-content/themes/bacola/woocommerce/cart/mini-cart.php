...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<div class="products woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
		<?php
                      ...
                      <div class="product-wrapper">
                        <div class="thumbnail-wrapper">
							<?php if ( empty( $product_permalink ) ) : ?>
								<?php echo bacola_sanitize_data($thumbnail); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
							<?php else : ?>
                          ...
                          <div class="entry-price">
							...
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									...
									esc_attr__( 'Remove this item', 'bacola' ),
									esc_attr( $product_id ),
	...
	<p class="woocommerce-mini-cart__buttons buttons"><?php
	echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="button wc-forward">' . esc_html__( 'View cart', 'woocommerce' ) . '</a>'; 
 echo '<a href="' . home_url( '/checkout' ) . '" class="button checkout wc-forward">' . esc_html__( 'Checkout', 'woocommerce' ) . '</a>';
 ?></p>
...
<?php else : ?>
	...
	<div class="cart-empty">
		...
		<div class="empty-text"><?php esc_html_e( 'VOTRE PANIER EST VIDE.', 'bacola' ); ?></div>
	</div><!-- cart-empty -->
