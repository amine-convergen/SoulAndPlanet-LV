...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
	...
	<div class="product-content">
		...
		<div class="row">
			<div class="col col-12 <?php if ($product_type != 'woosb') { echo 'col-lg-5'; } else { echo 'woosb'; } ?> product-images">
				<?php
				/**
			...
			<div class="col col-12 <?php if ($product_type != 'woosb') { echo ' col-lg-7' ; }?> product-detail">

				<?php do_action('bacola_single_header_side'); ?>

				<div class="column" <?php if ($product_type == 'woosb') { echo 'style= "max-width: 900px; margin: auto;"' ; }?>>
					<?php
					/**
				...
				<?php $typeProduct = $product->get_type();?>
				<?php if(get_theme_mod('bacola_shop_single_featured_toggle',0) == 1 and $typeProduct != 'woosb'){ ?>
