(function ($) {
  ...
  doc.ready( () => {
    ...
    $(window).scroll(function() {
        $(this).scrollTop() > 20 ? $("header.site-header").addClass("sticky-header") : $("header.site-header").removeClass("sticky-header")
    });
    // $(window).scroll(function() {
    //     $(this).scrollTop() < 20 ? $(".store-notice").fadeIn() : $(".store-notice").fadeOut()
    // });
